...
export interface ActivityDocument {
  ...
  module: 'AUTH' | 'DATABASE' | 'ADMIN' | 'SUPPORT' | 'SYSTEM' | 'NETWORK' | 'WORKER' | 'DISPATCHER' | 'PROCESSOR' | 'BROWSER' | 'SCRAPER' | 'SCRAPER_ENHANCED' | 'SCRAPER_LOGGER' | 'SCRAPER_NODE' | 'BRAND_MATCHING' | 'CATEGORY_MAPPING' | 'BRAND_EXTRACTION' | 'VTEX_SCRAPER' | 'PRODUCT_SAVER';
  message: string;
...
const ActivitySchema = new Schema<ActivityDocument>(
  {
    ...
    module: {
      ...
      enum: [
        ...
        'WORKER', 'DISPATCHER', 'PROCESSOR', 'BROWSER', 'SCRAPER',
